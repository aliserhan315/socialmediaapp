...
export default function MessagesPage() {
  ...
  return (
    <div className="p-4">
      ...
      <div className="h-[calc(100vh-200px)] w-full flex bg-white dark:bg-black text-black dark:text-white border border-gray-300 dark:border-white/10 rounded-b-lg overflow-hidden">
        <div className="w-full max-w-md border-r border-gray-300 dark:border-white/10 bg-white dark:bg-zinc-900">
          ...
          <div className="overflow-y-auto h-[calc(100vh-290px)]">
        ...
        <div className="flex-1 hidden lg:flex items-center justify-center bg-gray-100 dark:bg-zinc-950">
          <p className="text-gray-600 dark:text-zinc-600 text-lg">
